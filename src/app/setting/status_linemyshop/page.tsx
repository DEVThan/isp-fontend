...
import { getLineMyShops } from "@/app/setting/status_linemyshop/_components/api"
import type { LineMyShopList } from "@/app/setting/status_linemyshop/_components/model"
import { Tables } from "@/app/setting/status_linemyshop/_components/table"
...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("statuslinemyshops")
  return { title: t("title") }
}

export default async function LineMyShopPage() {
  const t = await getTranslations("statuslinemyshops")
  ...
  const initial = settleInitial(getLineMyShops(), empty)

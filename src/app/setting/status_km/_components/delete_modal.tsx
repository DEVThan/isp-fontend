...
import { deleteStatusKm } from "@/app/setting/status_km/_components/api"
import type { StatusKm } from "@/app/setting/status_km/_components/model"
import {
  Alert,
  AlertContent,
  AlertDescription,
...
/**
 * delete_modal.tsx — ถามยืนยันก่อนลบสถานะ KM แล้วค่อยยิง POST /api/web/status-km-delete
 *
...
export function DeleteModal({
  ...
  const key = `${km?.id ?? "none"}-${String(open)}`
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <DialogDescription>
          {tform("deleteDescription", { name: km?.name ?? "" })}
        </DialogDescription>

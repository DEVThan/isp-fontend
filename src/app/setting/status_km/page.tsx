...
import { getStatusKms } from "@/app/setting/status_km/_components/api"
import type { StatusKmList } from "@/app/setting/status_km/_components/model"
import { Tables } from "@/app/setting/status_km/_components/table"
...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("statuskms")
  return { title: t("title") }
}

export default async function StatusKmPage() {
  const t = await getTranslations("statuskms")
  ...
  const initial = settleInitial(getStatusKms(), empty)

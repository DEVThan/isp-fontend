...
import { deleteStatusPo } from "@/app/setting/status_po/_components/api"
import type { StatusPo } from "@/app/setting/status_po/_components/model"
import {
  Alert,
  AlertContent,
  AlertDescription,
...
/**
 * delete_modal.tsx — ถามยืนยันก่อนลบสถานะ PO แล้วค่อยยิง POST /api/web/status-po-delete
 *
...
export function DeleteModal({
  ...
  const key = `${po?.id ?? "none"}-${String(open)}`
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <DialogDescription>
          {tform("deleteDescription", { name: po?.name ?? "" })}
        </DialogDescription>

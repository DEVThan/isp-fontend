...
import { deleteKmProtocall } from "@/app/setting/status_kmprotocall/_components/api"
import type { KmProtocall } from "@/app/setting/status_kmprotocall/_components/model"
import {
  Alert,
  AlertContent,
  AlertDescription,
...
/**
 * delete_modal.tsx — ถามยืนยันก่อนลบสถานะ KM Protocall แล้วค่อยยิง POST /api/web/status-kmprotocall-delete
 *
...
export function DeleteModal({
  ...
  const key = `${protocall?.id ?? "none"}-${String(open)}`
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <DialogDescription>
          {tform("deleteDescription", { name: protocall?.name ?? "" })}
        </DialogDescription>

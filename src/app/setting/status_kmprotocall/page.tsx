...
import { getKmProtocalls } from "@/app/setting/status_kmprotocall/_components/api"
import type { KmProtocallList } from "@/app/setting/status_kmprotocall/_components/model"
import { Tables } from "@/app/setting/status_kmprotocall/_components/table"
...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("statuskmprotocalls")
  return { title: t("title") }
}

export default async function KmProtocallPage() {
  const t = await getTranslations("statuskmprotocalls")
  ...
  const initial = settleInitial(getKmProtocalls(), empty)

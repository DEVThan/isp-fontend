...
import { deleteStatusMou } from "@/app/setting/status_mou/_components/api"
import type { StatusMou } from "@/app/setting/status_mou/_components/model"
import {
  Alert,
  AlertContent,
  AlertDescription,
...
/**
 * delete_modal.tsx — ถามยืนยันก่อนลบสถานะ MOU แล้วค่อยยิง POST /api/web/status-mou-delete
 *
...
export function DeleteModal({
  ...
  const key = `${mou?.id ?? "none"}-${String(open)}`
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <DialogDescription>
          {tform("deleteDescription", { name: mou?.name ?? "" })}
        </DialogDescription>

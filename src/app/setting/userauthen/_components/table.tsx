 ...
 */
const EMPTY_LIST: UserAuthenList = {
  userauthens: [],
  total: 0,
  page: 1,
  per_page: 0,
...
export function Tables() {
   ...
   */
  React.useEffect(() => {
    const start = setTimeout(() => load({ username: nameQuery, role, status, page, pageSize }))

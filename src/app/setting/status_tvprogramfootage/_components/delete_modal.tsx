...
import { deleteTvFootage } from "@/app/setting/status_tvprogramfootage/_components/api"
import type { TvFootage } from "@/app/setting/status_tvprogramfootage/_components/model"
import {
  Alert,
  AlertContent,
  AlertDescription,
...
/**
 * delete_modal.tsx — ถามยืนยันก่อนลบสถานะ TV Program Footage แล้วค่อยยิง POST /api/web/status-tvprogramfootage-delete
 *
...
export function DeleteModal({
  ...
  const key = `${footage?.id ?? "none"}-${String(open)}`
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <DialogDescription>
          {tform("deleteDescription", { name: footage?.name ?? "" })}
        </DialogDescription>

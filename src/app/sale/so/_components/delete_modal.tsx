...
import { deleteSo } from "@/app/sale/so/_components/api"
import type { So } from "@/app/sale/so/_components/model"
import {
  Alert,
  AlertContent,
  AlertDescription,
...
/**
 * delete_modal.tsx — ถามยืนยันก่อนลบรายการแล้วค่อยยิง POST /api/web/so-delete
 *

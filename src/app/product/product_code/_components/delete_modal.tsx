...
import { deleteProductCode } from "@/app/product/product_code/_components/api"
import type { ProductCode } from "@/app/product/product_code/_components/model"
import {
  Alert,
  AlertContent,
  AlertDescription,
...
/**
 * delete_modal.tsx — ถามยืนยันก่อนลบรหัสสินค้าแล้วค่อยยิง POST /api/web/product-code-delete
 *
...
export function DeleteModal({
  ...
  const key = `${code?.id ?? "none"}-${String(open)}`
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        ...
        <DialogDescription>
          {tform("deleteDescription", { name: code?.name ?? "" })}
        </DialogDescription>

...
import { getProductItems } from "@/app/product/product_item/_components/api"
import type { ProductItemList } from "@/app/product/product_item/_components/model"
import { Tables } from "@/app/product/product_item/_components/table"
...
export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("productitems")
...
export default async function ProductItemPage() {
  ...
  const initial = settleInitial(getProductItems(), empty)

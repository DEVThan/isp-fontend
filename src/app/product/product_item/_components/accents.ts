/**
 * accents.ts — สีประจำกลุ่มข้อมูลสินค้า ใช้ร่วมกันระหว่างฟอร์ม (form_modal) กับกล่องดูข้อมูล (view_modal)
 * กลุ่มเดียวกันได้สีเดียวกันทั้งสองกล่อง: ข้อมูลหลัก = blue · ประเภทและกลุ่ม = yellow · ราคา = orange
 * ผู้ขายและการจัดส่ง = aqua · สถานะและเอกสาร = magenta · อื่น ๆ = neutral
 *
 * ใช้ชุด chart-1..5 แบบเดียวกับไล่เฉดของโลโก้/ปุ่มหลัก เป็นสีตกแต่งอย่างเดียว ไม่ได้สื่อความหมาย
 * ไม่ใช้ success/warning/danger/info เพราะสีพวกนั้นสงวนไว้บอกสถานะ (ป้ายใช่/ไม่ใช่ เปิด/ปิดขาย กรอบแดงช่องบังคับ)

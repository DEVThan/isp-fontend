...
import { deleteProductType } from "@/app/product/product_type/_components/api"
import type { ProductType } from "@/app/product/product_type/_components/model"
import {
  Alert,
  AlertContent,
  AlertDescription,
...
/**
 * delete_modal.tsx — ถามยืนยันก่อนลบประเภทสินค้าแล้วค่อยยิง POST /api/web/product-type-delete
 *

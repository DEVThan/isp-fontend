...
/**
 * ⚠️ ไม่มีใครเรียกแล้ว (2026-09-14) — /login ส่งเมนูเต็มมาเลย login-form สร้างต้นเมนูด้วย toNavGroups
 *    แล้วเก็บลง cookie isp_menus · เก็บฟังก์ชันนี้ไว้เผื่อต้องกลับไปดึงเมนูสดทุกครั้งที่โหลดหน้า
 *
 * POST /api/web/menu-get — ส่ง id เมนูที่ผู้ใช้มีสิทธิ์ แล้วรับรายละเอียดกลับ
 *
